...
export const TeamPage: React.FC = () => {
  const teamMembers: TeamMember[] = [
    {
      ...
      bio: 'Specializes in disaster event intelligence, source ingestion, and full-stack platform delivery.',
      isLead: true,
    },
    {
      ...
      bio: 'Specializes in machine learning workflows, event classification, and resilient data pipelines.',
      isLead: false,
    },
    {
      name: 'Aditya Arpit',
      ...
      bio: 'Directs platform architecture, geospatial relevance engines, and multi-workspace integrations.',
      isLead: false,
    },
    {
  ...
  const techStack = [
    ...
    { category: 'Data Platform', items: ['Supabase PostgreSQL', 'PostGIS', 'pgvector'] },
  ];
      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="text-center space-y-2 animate-in fade-in slide-in-from-top-4 duration-500">
          ...
          <p className="text-sm text-[#747F8D] max-w-lg mx-auto">
            Combining machine learning, geospatial analysis, and verified evidence into India's disaster intelligence platform.
          </p>
        </div>
